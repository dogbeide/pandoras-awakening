...
export default function SocialIcons({ footer=false } : 
  SocialIconsProps  
) {
  return (
    <div className="social-icons flex flex-row justify-between w-28 my-1">
      ...
      {footer && <a aria-label="LinkedIn" href='https://www.linkedin.com/in/renee-burwell-lcsw-cst-2926126/' target='_blank' className={`px-1`} >
        <span className="[&>svg]:h-3 [&>svg]:w-3">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="currentColor"
